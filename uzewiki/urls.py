...
if settings.SINGLE:
    ...
    urlpatterns = patterns('uzewiki.views',
        ...
        url(r'^:asset/(?P<asset_name>[-\w]+)/$', 'asset_details', url_dict,
            name='uzewiki-asset',
        ),
        url(r'^:asset/(?P<asset_name>[-\w]+)/edit/$', 'asset_edit', url_dict,
    ...
    urlpatterns = patterns('uzewiki.views',
        ...
        url(r'^(?P<wiki_slug>[-\w]+)/:asset/(?P<asset_name>[-\w]+)/$',
            'asset_details',
            name='uzewiki-asset',
        ),
        url(r'^(?P<wiki_slug>[-\w]+)/:asset/(?P<asset_name>[-\w]+)/edit/$',
            'asset_edit',
            name='uzewiki-asset-edit',
        ),
        url(r'^$', 'index',
