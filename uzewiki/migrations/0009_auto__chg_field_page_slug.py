...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'uzewiki_page', 'slug', self.gf('uzewiki.fields.WikiSlugField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Page.slug'
        db.alter_column(u'uzewiki_page', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
