...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Page._content_html'
        db.delete_column(u'uzewiki_page', '_content_html')


    def backwards(self, orm):
        # Adding field 'Page._content_html'
        db.add_column(u'uzewiki_page', '_content_html',
