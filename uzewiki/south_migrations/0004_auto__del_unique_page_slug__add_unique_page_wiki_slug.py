...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'uzewiki_page', ['slug'])

        # Adding unique constraint on 'Page', fields ['wiki', 'slug']
        db.create_unique(u'uzewiki_page', ['wiki_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Page', fields ['wiki', 'slug']
        db.delete_unique(u'uzewiki_page', ['wiki_id', 'slug'])

        # Adding unique constraint on 'Page', fields ['slug']
        db.create_unique(u'uzewiki_page', ['slug'])
