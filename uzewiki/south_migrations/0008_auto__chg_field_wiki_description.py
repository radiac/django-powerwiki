...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Wiki.description'
        db.alter_column(u'uzewiki_wiki', 'description', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Wiki.description'
        db.alter_column(u'uzewiki_wiki', 'description', self.gf('django.db.models.fields.TextField')(null=True))
