...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'uzewiki_wikipermissions', 'can_edit')

        # Deleting field 'Wiki.can_read'
        db.delete_column(u'uzewiki_wikipermissions', 'can_read')
        
        # Changing field 'WikiPermissions.can_read'
        db.add_column(u'uzewiki_wikipermissions', 'can_read',
            self.gf('django.db.models.fields.BooleanField')(default=False))

        # Changing field 'WikiPermissions.can_edit'
        db.add_column(u'uzewiki_wikipermissions', 'can_edit',
            self.gf('django.db.models.fields.BooleanField')(default=False))
